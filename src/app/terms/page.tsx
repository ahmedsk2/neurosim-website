  ...
  return (
    <div className="prose-mnm prose-wide">
      <PageHeader
        eyebrow="Terms"
        title="Terms of use"
        description="The rules for using MNM-Edu. DRAFT pending legal review."
      />
      ...
      <Callout type="caveat" title="Draft - pending legal review" className="my-3">
        <p className="m-0 mb-2">
          ...
          publication.</strong> The disclaimer-of-warranties, limitation-of-liability, and
          indemnification sections in particular need counsel input.
        </p>
        <p className="m-0">
      ...
      <p>
        ...
        <code>web.towardpcc.com</code>) you agree to these Terms of Use and to the{' '}
      ...
      <p>
        <em>[LEGAL REVIEW: confirm the user-content licence wording and PHI confirmation language;
        clarify how moral rights interact in Canada.]</em>
      </p>
      ...
      <p>
        <em>[LEGAL REVIEW: confirm the precise warranty-disclaimer language for Canadian
        common-law and Quebec civil-law contexts.]</em>
      </p>
      ...
      <p>
        <em>[LEGAL REVIEW: this is the section most needing counsel - precise wording for
        consumer-protection statutes in Canadian provinces (especially Quebec), and any
        professional-liability nuance for a clinician author publishing clinical educational
        content.]</em>
      </p>
      ...
      <p>
        <em>[LEGAL REVIEW: confirm scope and enforceability of indemnification clauses against a
        private individual under Canadian law.]</em>
      </p>

      <h2>10. Third-party services and links</h2>
      <p>
        The site is fronted by Cloudflare, hosted by a PaaS provider, uses Google Analytics for
        consented public analytics, and links to external resources (journal DOIs, open-access
        articles, vendor documentation). The named author is not responsible for the content,
        availability, or privacy practices of third-party services or sites.
      </p>
      ...
      <p>
        <em>[LEGAL REVIEW: confirm the chosen governing law and forum, and the enforceability of
        the forum-selection clause against international visitors.]</em>
      </p>
