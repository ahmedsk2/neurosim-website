...
const base =
  'tap-target inline-flex items-center justify-center rounded-[5px] px-4 py-2 text-[12px] font-bold uppercase tracking-[0.04em] transition-colors disabled:opacity-50 disabled:cursor-not-allowed';
